...
$moduleName = 'Expenses';
$moduleNs = 'Modules\Expenses';
$contextNs = 'Modules\\Expenses\\Filament';
...
return [
    ...
    */
    ...
    'auth' => [
        ...
        'pages' => [
            'login' => Modules\Expenses\Http\Livewire\Auth\FilamentLogin::class,
        ],
    ],
    ...
    */
    ...
    'middleware' => [
        'auth' => [
        //  Authenticate::class,
            Modules\Expenses\Http\Middleware\FilamentMiddleware::class
        ],
        'base' => [
