...
$moduleNs = 'Modules\Accountancy';
$contextNs = 'Modules\\Accountancy\\Filament';
...
return [
    ...
    */
    ...
    'auth' => [
        ...
        'pages' => [
            'login' => Modules\Accountancy\Http\Livewire\Auth\FilamentLogin::class,
        ],
    ],
    ...
    */
    ...
    'middleware' => [
        'auth' => [
        //  Authenticate::class,
            Modules\Accountancy\Http\Middleware\FilamentMiddleware::class
        ],
        'base' => [
